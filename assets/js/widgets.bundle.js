...
var KTTablesWidget4 = function () {
    ...
    const handleActionButton = () => {
        ...
        buttons.forEach((button, index) => {
            button.addEventListener('click', e => {
                ...
                var idOrder = button.value; 

                function getListItemOrder() {
                    return $.ajax({ 
                        type: 'GET', 
                        url: '../../processCallOrderItem.php', 
                        data: { id: idOrder }, 
                        dataType: "json",
                        async: false,
                ...
                $.when(getListItemOrder()).done(function(){
                    ...
                    if (row.classList.contains('isOpen')) {
                        ...
                        populateTemplate(itemOrder, row);
    ...
    const populateTemplate = (data, target) => {
        data.forEach((d, index) => {
            ...
            // Stock badges
            const lowStock = `<div class="badge badge-light-warning">Còn ít hàng</div>`;
            const inStock = `<div class="badge badge-light-success">Còn hàng</div>`;
            ...
            total.innerText = (new Intl.NumberFormat('vi-VN', {
                style: 'currency',
                currency: 'VND'
            }).format(d.total));
            ...
            image.setAttribute('src', imageSrc + d.image);
